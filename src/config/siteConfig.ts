...
export const siteConfig: SiteConfig = {
  title: "Kallian.skill",
  subtitle: "ver.2.0",
  siteURL: "https://kallianx.github.io/", // 请替换为你的站点URL，以斜杠结尾
  siteStartDate: "2024-10-13", // 站点开始运行日期，用于站点统计组件计算运行天数
  ...
  bilibili: {
    vmid: "572967374", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
  ...
  banner: {
    ...
    homeText: {
      ...
      subtitle: [
        ...
        "Destiny is a heavy burden to bear...",
      ],
      typewriter: {
        enable: true, // 启用副标题打字机效果
        speed: 15, // 打字速度（毫秒）
        deleteSpeed: 15, // 删除速度（毫秒）
  ...
  font: {
    ...
    asciiFont: {
      ...
      fontFamily: "思源黑体 CN Heavy", // 英文字体名称，需与引入的字体文件中的 font-family 定义一致
      fontWeight: "400",
      localFonts: ["SourceHanSansCN-Heavy.otf"], // 本地字体文件路径，需放在 public 目录下，例如 public/fonts/SourceHanSansCN-Heavy.otf
      enableCompress: true, // 启用字体子集优化，减少字体文件大小
    },
    cjkFont: {
      // 中日韩字体 - 作为回退字体
      fontFamily: "字魂独角兽体", // 中日韩字体名称，需与引入的字体文件中的 font-family 定义一致
      fontWeight: "500",
      localFonts: ["ZihunDujiaoshou.ttf"], // 本地字体文件路径，需放在 public 目录下，例如 public/fonts/ZihunDujiaoshou.ttf
      enableCompress: true, // 启用字体子集优化，减少字体文件大小
    },
  },
